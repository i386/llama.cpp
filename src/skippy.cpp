...
static enum skippy_status skippy_model_open_impl(
    ...
    *out_model = nullptr;
    ...
    if (config != nullptr) {
        ...
        params.use_mmap_buffer = config->use_mmap_buffer;
